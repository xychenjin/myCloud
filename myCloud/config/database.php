    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database'  => env('DB_DATABASE', 'db_first'),
            'username'  => env('DB_USERNAME', 'jimm'),
            'password'  => env('DB_PASSWORD', '123456s'),
            'charset'   => 'utf8',
        ...
        'db_myhome' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST_HOME', ''),
            'database'  => env('DB_DATABASE_HOME', ''),
            'username'  => env('DB_USERNAME_HOME', ''),
